...
TEST_CASE("WfcGeneratorUnitTests", "[PPG_UNIT_TEST]") {

	GIVEN("WFC-Generator & a simple Puzzle Relation with 4 nodes and a simple Relation N1->N2->N3") {
	...
	GIVEN("WFC-Generator & A more extensive puzzle universe with X nodes and rules") {
